...
pub const SWITCH_TO_MAIN_MENU: Selector = Selector::new("switch-to-hauptmenu");
pub const CALCULATE_KEYPAIR_ALICE: Selector = Selector::new("calculate-keypair-alice");
