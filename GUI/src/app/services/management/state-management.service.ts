...
import {createDefaultConfigurationData} from "../../models/configuration-data";
...
export class StateManagementService {
    ...
    private configurationData = signal(createDefaultConfigurationData())
    ...
    public createClient(clientName: string): void {
        ...
        this.clientKeyMap.set(client, signal(createEmptyKeyPair()));
